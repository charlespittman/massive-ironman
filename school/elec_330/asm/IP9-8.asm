...
ANODE_CODE:	MOVFF	POSTINC0,PORTB	;Output code and increment pointer
		...
		RLNCF	DIGIT_ON,F	;Get ready to turn next LED
		DECF	COUNTR,F	;Next count
...
LOOP1:		DECF	L1REG, 1	;Decrement count in L1REG
		...
		BNZ	LOOP2 		;Go back to load L1REG and start LOOP1
		RETURN
		END

;Common cathode seven-segment LED code for 2006:

;CODEREG:	REG20: 0x6F		;Digit 9
;		Reg21: 0x3F		;Digit 0
;		Reg22: 0x3F		;Digit 0
;		Reg23: 0x5B		;Digit 2
