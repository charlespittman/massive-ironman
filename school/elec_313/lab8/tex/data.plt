...
#set xlabel "$V_{in}$"
#set ylabel "Gain"
plot 'data.dat' using 3:2 title "$I_B = \SI{20}{\micro\ampere}$" with linespoints, \
     'data.dat' using 5:4 title "$I_B = \SI{50}{\micro\ampere}$" with linespoints, \
     'data.dat' using 7:6 title "$I_B = \SI{80}{\micro\ampere}$" with linespoints, \
     'data.dat' using 9:8 title "$I_B = \SI{100}{\micro\ampere}$" with linespoints