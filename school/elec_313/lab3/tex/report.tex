...
%[ ] Comparison of the computed open-circuit voltages (prelab–part B) and the measured ones (step 4) over the range of RL.

%[ ] Comparison of the measured drop out voltage (step 5) with the computed values from the prelab–part C over the range of RL.
