...
%%%%%
%%%%% Needed to turn some of these off for layout
%%%%%
\begin{table}[btph]
  \centering
...
%%%%%
%%%%% I'm taking this out because we didn't include any values from
%%%%% PSpice, so it doesn't make sense to refer to them.
%%%%%
...
% seen in Table B, the values measured of $V_d$ and the $I_d$ taken in
