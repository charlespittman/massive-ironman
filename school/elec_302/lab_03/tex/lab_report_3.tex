...
the admittance Y$_E$ = \frac{I$_OC$}{V$_OC$}\angle{-\theta} = \frac{1}{R$_C$} - j\frac{1}{X$_M$}
the series impedance Z$_SE$ = \frac{V$_SC$}{I$_SC$}\angle{\theta} = R$_EQ$ + jX$_EQ$
...
Equations Used:
VR = \frac{V$_P$ - V$_S$}{V$_S} * 100\% ; V$_P$ = V$_S$ + R$_EQ$I$_S$ + jX$_EQ$I$_S$
\eta = \frac{P$_OUT$}{P$_IN$} * 100\% = \frac{V$_S$I$_S$\cos\theta}{P$_Cu$ + P$_Core$ + V$_S$I$_S$\cos\theta}
Percent Diff. = \frac{difference}{average} * 100\%
