...
%	The fields in capacitors and inductors continued to grow in \ac{DC} circuits
%	until they stopped current and voltage, respectively.  Those fields are
%	discharged when the current flow reverses
